...
pub fn lookup_routine_name(routine_id: u16, lang: Language) -> &'static str {
    match lang {
        Language::En => match routine_id {
            ...
            0x0204 => "SBC Brake Pad Replacement Deactivation (0 Bar)",
            0x0205 => "SBC Brake Hydraulic Bleed Routine",
            0x0206 => "SBC Brake System Reactivation & Pressure Charge",
            ...
            0x0218 => "AdBlue / SCR Induction Lockout Warning Reset",
            0x0220 => "ABC Hydraulic Surge Limiter (120 Bar Fallback)",
            0x0221 => "ABC Strut Isolation Valve Lockout",
        ...
        Language::De => match routine_id {
            ...
            0x0204 => "SBC Bremsbelagwechsel Deaktivierung (0 Bar)",
            0x0205 => "SBC Bremsen-Hydraulik Entlüftungsroutine",
            0x0206 => "SBC Bremssystem Reaktivierung & Druckaufbau",
            ...
            0x0218 => "AdBlue / SCR Startsperre Warnung Rücksetzen",
            0x0220 => "ABC Hydraulik-Druckentlastung (120 Bar Notlauf)",
            0x0221 => "ABC Federbein-Absperrventil Verriegelung",
        ...
        Language::Sv => match routine_id {
            ...
            0x0204 => "SBC Bromsbeläggsbyte Avaktivering (0 Bar)",
            0x0205 => "SBC Bromshydraulik avluftningsrutin",
            0x0206 => "SBC Bromssystem Återaktivering & Tryckuppbyggnad",
            ...
            0x0218 => "AdBlue / SCR Startspärr Varningsåterställning",
            0x0220 => "ABC Hydraulik tryckavlastning (120 Bar reservläge)",
            0x0221 => "ABC Fjäderbensavstängningsventil låsning",
