...
use sterngate_core::{
    ...
    FirmwareSignatures, FirmwareVault, FlashPackageManifest, FlashProgress, Language, ModAction,
    ModCategory, ModMetadata, ModRiskLevel, ModTargetFilter, SbcServiceAction, SterngateMod,
